...
async function loadData() {
    try {
        ...
        // MovieLens 100K u.item uses ISO-8859-1. Decode it explicitly so accented
        // titles and alphabetical tie-breaking match the offline experiment.
...
function parseItemData(text) {
    ...
    for (const line of lines) {
        ...
        // Field 5 is the legacy "unknown" flag; fields 6-23 are the 18 genres.
